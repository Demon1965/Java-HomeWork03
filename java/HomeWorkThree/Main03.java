 ...
 */
    ...
    public static List<Integer> listGen(int length, int min, int max){
        ...
        int lengthList = rnd.nextInt(length);
    ...
    public static void main03(String[] args) {
        ...
        System.out.println("Start list" + integerList);
        ...
        System.out.println("Without even numbers" + integerList);
    }
}
